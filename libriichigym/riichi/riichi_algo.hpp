...
bool board_set_tumo_yakucombos(Board&) noexcept;

ActionGroup board_calculate_loot_group(const Board&) noexcept;
ActionGroup board_calculate_rong_group_and_set_yakucombos(Board&) noexcept;
...
void board_restart(Board&) noexcept;
void board_calculate_and_update_score(Board&) noexcept;
bool board_clean_and_can_restart(Board&) noexcept;
